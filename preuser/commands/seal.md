---
description: Seal a PR-run credential for preuser — encrypt a login value with preuser's public key so you can commit it (the ciphertext) in .preuser/config.yml. preuser decrypts it trusted-side; the value is never shown to the AI user.
---
